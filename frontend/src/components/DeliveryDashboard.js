...
function DeliveryDashboard() {
  ...
  const handleScanError = (error) => {
    ...
    setError(
      "Failed to scan QR code. Please try again or enter the code manually."
    );
  };
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusBgColor(
                            order.status
                          )} text-white`}
                        >

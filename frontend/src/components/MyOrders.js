...
import { Package, Clock, MapPin, User, CheckCircle, Truck, AlertCircle, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">My Orders</h1>
            <p className="text-orange-100 text-sm sm:text-base">Track your delicious meals and order history</p>
          </div>
        </div>
      </div>
        ...
        {orders.length === 0 ? (
          <div className="text-center py-12">
            <div className="bg-gray-800 rounded-xl p-8 sm:p-12 max-w-md mx-auto">
              ...
              <p className="text-gray-400 mb-6">You haven't placed any orders yet. Start exploring our delicious menu!</p>
              <Link 
                to="/home" 
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 space-y-2 sm:space-y-0">
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="font-semibold text-white">Order #{order.token}</span>
                      </div>
                      ...
                      {order.delivery_person && (
                        <div className="flex items-center space-x-2 text-sm text-gray-400 mt-1">
                          ...
                          <span>Delivery Person: <span className="font-medium text-white">{order.delivery_person.name}</span></span>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="mb-4 p-3 bg-gray-700 rounded-lg">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        <p className="font-medium text-white text-sm mb-1">Delivery Address:</p>
